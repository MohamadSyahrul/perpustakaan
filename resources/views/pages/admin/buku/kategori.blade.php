                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="mediumModalLabel">Tambah Data Kategori</h5>
                                    ...
                                    <div class="modal-body">
                                        <p>
                                            <div class="has-success form-group"><label for="inputIsValid"
                                                    class=" form-control-label">Nama Kategori</label>
                                                <input type="text" name="nama" placeholder="contoh : Pemrograman Web"
                                                    id="inputIsValid"
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="editModal{{$item->id}}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="mediumModalLabel">Update Kategori</h5>
                                                        ...
                                                        <form action="{{route('kategori.update', $item->id)}}"
                                                            ...
                                                            <div class="card-body card-block">
                                                                ...
                                                                <div class="form-group"><label for="nf-username"
                                                                        class=" form-control-label">Nama Kategori</label><input
                                    ...
                                    <form action="{{route('kategori.destroy',$item->id)}}" method="post" style="display: inline;" onsubmit="return confirm('Yakin hapus data ?')">
                                        @csrf
                                        @method('DELETE')
